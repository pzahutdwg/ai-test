...
excludedWords = ['of', 'as', 'to', 'and', 'the', 'a', 'to', 'of', 'as', 'is', 'in', 'that', 'there', 'are', 'eg', 'or', 'because', 'they', 'was', 'for', 'by', 's', 'at', 'an', 'this', 'it', 'its', 'on', 'has', 'have', 'than' ,'', 'with', 'but', 'not', 'also', 'such', 'be', 'which', 'were', 'from', ' ']
